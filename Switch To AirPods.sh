...
# Replace all instances of Arnav's TidePods with the name of your desired audio output device
...
do shell script "echo Audio switched to Arnav's TidePods"